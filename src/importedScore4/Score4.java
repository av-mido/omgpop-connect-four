...
public class Score4 {
    ...
    public static final int orangeWins = 1000000;
    public static final int yellowWins = -orangeWins;
    public static int g_maxDepth = 8; //7 = original, 10 = up to 36 secs
    static boolean g_debug = false;

    public static enum Mycell {
        Orange,
        Yellow,
        Barren;
    }
...
System.out.println("test");
    ...
    public static int scoreBoard(Board board) {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 3; x < width; x++) {
                ...
                score -= scores[y][x - 3]; //only keep track of 4 squares at a time!
            }
        }
        // Vertical spans
        for (int x = 0; x < width; x++) {
    ...
    public static ScoreMoveTuple abMinimax(boolean maximizeOrMinimize, Mycell color, int depth, Board board) {
